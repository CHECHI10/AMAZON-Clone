...
//    .innerHTML = paymentSummaryHTML;
  ...
  const paymentSummary1 = document.querySelector('.js-payment-summary');
    
  if (paymentSummary1) {
    paymentSummary1.innerHTML = paymentSummaryHTML;
  }
  ...
  if(placeOrderButton) {
    placeOrderButton.addEventListener('click', async () => {
      if(isCartEmpty) return; // Prevents click event when disabled.
